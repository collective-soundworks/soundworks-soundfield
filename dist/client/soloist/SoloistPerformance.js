...
var SoundfieldPerformance = (function (_clientSide$Performance) {
  _inherits(SoundfieldPerformance, _clientSide$Performance);

  function SoundfieldPerformance() {
    var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

    _classCallCheck(this, SoundfieldPerformance);

    _get(Object.getPrototypeOf(SoundfieldPerformance.prototype), 'constructor', this).call(this, options);
  ...
  _createClass(SoundfieldPerformance, [{
    key: 'start',
    ...
    value: function start() {
      _get(Object.getPrototypeOf(SoundfieldPerformance.prototype), 'start', this).call(this);
    ...
    value: function reset() {
      _get(Object.getPrototypeOf(SoundfieldPerformance.prototype), 'reset', this).call(this);
